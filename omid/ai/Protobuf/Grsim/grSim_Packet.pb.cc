...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_grSim_5fPacket_2eproto_getter() {
...
void grSim_Packet::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<grSim_Packet *>(to)->MergeFrom(
      static_cast<const grSim_Packet &>(from));
}
