...
const int PenaltyAreaRadius = 2000;//also knwon as mohavate jarime
...
const int SurroundFieldLength = 9600;
const int SurroundFieldWidth = 6600;
...
const int PenaltyAreaWidth = 1000;
